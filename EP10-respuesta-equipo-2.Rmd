...
```
Notamos que el caso 10, 11,61, 71, 131 y 341 podrían considerarse problemáticos por la distancia de Cook que presentan. Para evaluar estos utilizaremos la funcion `compareCoefs`
...
# 10, 11, 22, 181
```
Notamos que el caso 10, 11, 22 y 181 **podrían** considerarse problemáticos por la distancia de Cook que presentan. Para evaluar estos utilizaremos la funcion `compareCoefs` nuevamente
