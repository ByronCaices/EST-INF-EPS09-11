...
```
Luego de aplicar la regresión paso a paso escalonada obtenemos un modelo en base a la altura y el peso adicional a , lo cual tiene todo el sentido, puesto que el estado nutricional depende del IMC, el cual es calculado en base a la altura y el peso de la persona
