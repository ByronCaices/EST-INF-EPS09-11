...
modelo_final <- names(which(modelo_sets_resumen[["which"]][modelo_sets_i_mejor, ])[-1])
...
```{r modelo 2}
texto <- paste(modelo_final, collapse = " + ")
...
```
Para evitar problemas eliminamos los predictores Hip.Girth , Elbows.diameter y Thigh.Girth ya que tienen un VIF preocupante
```{r}
